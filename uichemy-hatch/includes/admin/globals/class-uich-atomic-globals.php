							...
							'props' => array(
								'padding' => array(
									...
									'value'  => array(
										'block-start'  => array(
											'$$type' => 'size',
											'value'  => Uich_Atomic_Globals::parse_size_string( $bp['top'] ?? '0px' ),
										),
										'block-end'    => array(
											'$$type' => 'size',
											'value'  => Uich_Atomic_Globals::parse_size_string( $bp['bottom'] ?? '0px' ),
										),
										'inline-start' => array(
											'$$type' => 'size',
											'value'  => Uich_Atomic_Globals::parse_size_string( $bp['left'] ?? '0px' ),
										),
										'inline-end'   => array(
											'$$type' => 'size',
											'value'  => Uich_Atomic_Globals::parse_size_string( $bp['right'] ?? '0px' ),
										),
									),
								),
							),
