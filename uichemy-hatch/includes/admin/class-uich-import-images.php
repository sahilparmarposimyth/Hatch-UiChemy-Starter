	...
	class Uich_Import_Images {
		...
		public static function check_block_image_upload( $block_data ) {
			if ( isset( $block_data['blockName'] ) && isset( $block_data['attrs'] ) ) {
				...
				// Spectra Image Block
				if ( 'uagb/image' === $block_data['blockName'] ) {
				...
				elseif ( 'uagb/container' === $block_data['blockName'] ) {
				...
				// Core Image Block
				elseif ( 'core/image' === $block_data['blockName'] ) {
				...
				elseif ( 'core/group' === $block_data['blockName'] ) {
				...
				// Kadence Image Block
				elseif ( 'kadence/image' === $block_data['blockName'] ) {
				...
				elseif ( 'kadence/column' === $block_data['blockName'] ) {
				...
				elseif ( 'generateblocks/media' === $block_data['blockName'] ) {
				...
				elseif ( 'generateblocks/element' === $block_data['blockName'] ) {
					if ( isset( $block_data['attrs']['styles'] ) && isset( $block_data['attrs']['styles']['backgroundImage'] ) ) {
						$link   = str_replace( array( 'url(', ')' ), '', $block_data['attrs']['styles']['backgroundImage'] );
		...
		public static function block_data_instance( array $block_data, array $args = array(), $block_args = null ) {
