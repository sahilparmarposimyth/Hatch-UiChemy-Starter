...
const Check = (props) => <HugeiconsIcon icon={Tick02Icon} size={16} {...props} />;
const ChevronRight = (props) => <HugeiconsIcon icon={ArrowRight01Icon} size={16} {...props} />;
const Circle = (props) => <HugeiconsIcon icon={CircleIcon} size={8} {...props} />;
...
const ContextMenuContent = React.forwardRef(({ className, container, ...props }, ref) => {
  const ctxContainer = usePortalContainer();
  return (
    <ContextMenuPrimitive.Portal container={container ?? ctxContainer ?? undefined}>
